...
# Начинаем с указанного количества клиентов (1 - по умолчанию)
...
a = clients_count / 2
# Если тест сразу был не пройден
if clients_count == start_clients_count:
	a = 1
...
clients_count = a
print "Maximum clients = " + str(clients_count)
