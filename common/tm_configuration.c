...
ConfigurationStatus tm_configuration_configure(void)
{
	...
	TM_LOG_TRACE("copy: %d; mempool: %d; jemalloc: %d; libev: %d", configuration.copy_block_on_transfer, configuration.use_mempool, configuration.use_jemalloc, configuration.use_libev);
